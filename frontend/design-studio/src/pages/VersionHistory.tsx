...
export default function VersionHistory(): JSX.Element {
  ...
  // Mock version history data (ISO strings for consistency)
        ...
        <Box sx={{ py: 4 }}>
          <Alert severity="info">
            ...
            <Typography variant="body2" sx={{ mt: 1 }}>
              Go to the Workflows section and select a workflow to see its edit
        ...
        >
          <Box>
            ...
            <Typography variant="body1" color="text.secondary">
              Track changes and restore previous versions of workflow{" "}
              {workflowId.slice(-4)}
            </Typography>
          </Box>
